"""
Django settings for softsiud_backend project.
...
SECRET_KEY = 'django-insecure-m#rxz&bal_vrfxz$@+ba_y%1*4y^07!)!gxrbtvy$0a=niv*hm'
...
ROOT_URLCONF = 'softsiud_backend.urls'
...
WSGI_APPLICATION = 'softsiud_backend.wsgi.application'
